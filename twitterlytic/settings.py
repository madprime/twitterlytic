...
# Set max for page loading issues.
TWITTERLYTIC_PROFILE_DISPLAY_MAX = int(os.getenv('TWITTERLYTIC_PROFILE_DISPLAY_MAX', '1000'))
TWITTERLYTIC_MAX_RESUBMIT = int(os.getenv('TWITTERLYTIC_MAX_RESUBMIT', '3'))
